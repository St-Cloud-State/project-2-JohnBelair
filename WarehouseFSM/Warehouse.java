...
public class Warehouse {
    ...
    public void displayClientByID(String ClientID){
        newClientList.displayClientByID(ClientID);
    }
    ...
    public void displayClientsWithOutstandingBalance() {
        if (newClientList.isEmpty()) {
            ...
            newClientList.displayClientsWithOutstandingBalance();
        }
    }
    ...
    public void receiveShipmentFromUser(String productId, int productQty) {
        // Check if any products from the waitlist need to be fulfilled
        int remainingQty = waitlist.fulfillProduct(productId, productQty, this);

        // Retrieve the current quantity of the product
        int currentQty = newProductList.getQtyById(productId);

        // Add the remainingQty to the current quantity of the product
        int updatedQty = currentQty + remainingQty;

        // Update the quantity in the product list
        newProductList.setQtyById(productId, updatedQty);
    ...
    public void searchProductWaitlist(String productId) {
        System.out.println(waitlist.getWaitlistByProductId(productId));
    }
}
